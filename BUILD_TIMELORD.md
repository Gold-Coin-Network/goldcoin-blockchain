...
required to run a [Timelord](https://github.com/pinksheetscrypto/goldcoin-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/pinksheetscrypto/goldcoin-blockchain/blob/main/install-timelord.sh)
