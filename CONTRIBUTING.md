...
Contact any of the team members on [Keybase](https://keybase.io/team/goldcoin_network.public), which we use as the main communication method. You can also comment on any Trello card.
...
. ./activate
pip install ".[dev]"
black goldcoin tests && mypy goldcoin tests && flake8 goldcoin tests
...
7. Preferences > Settings > mypy > Targets: set to `./goldcoin` and `./tests`
