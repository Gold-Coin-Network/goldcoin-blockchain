...
{
    Write-Output "Goldcoin requires a 64-bit Windows installation"
    Exit 1
}
...
Write-Output ""
Write-Output "Goldcoin blockchain .\Install.ps1 complete."
Write-Output "For assistance join us on Keybase in the #support chat channel:"
Write-Output "https://keybase.io/team/goldcoin_network.public"
Write-Output ""
Write-Output "Try the Quick Start Guide to running goldcoin-blockchain:"
Write-Output "https://github.com/Goldcoin-Network/goldcoin-blockchain/wiki/Quick-Start-Guide"
Write-Output ""
Write-Output "To install the GUI type '.\Install-gui.ps1' after '.\venv\scripts\Activate.ps1'."
Write-Output ""
Write-Output "Type '.\venv\Scripts\Activate.ps1' and then 'goldcoin init' to begin."
