...
rm -rf ../venv || true
rm -rf venv || true
rm -rf goldcoin_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf goldcoin-blockchain-gui/build || true
rm -rf goldcoin-blockchain-gui/daemon || true
rm -rf goldcoin-blockchain-gui/node_modules || true
rm goldcoin-blockchain-gui/temp.json || true
( cd "$PWD/goldcoin-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
