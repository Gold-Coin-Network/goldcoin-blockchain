...
This library provides react hooks on the top of @goldcoin/api and uses [RTK Query](https://redux-toolkit.js.org/rtk-query/overview) under do hood.
...
- Automatically refresh queries when data changed (using events from Goldcoin Blockchain).
...
import { useGetPublicKeysQuery } from '@goldcoin/api-react';
...
import { store, api } from '@goldcoin/api-react';
