...
This library provides support for TypeScript/JavaScript [Goldcoin](https://www.goldcoin-network.net) apps to access the [Goldcoin Blockchain RPC](https://github.com/Goldcoin-Network/goldcoin-blockchain/wiki/RPC-Interfaces), by making it easier to perform the following actions:

- Making requests to the Goldcoin Blockchain RPC.
...
```ts
import Client, { Wallet } from '@goldcoin/api';
