...
import goldcoinToMojo from '../../utils/goldcoinToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isGoldcoinCurrency = ['OZT', 'TOZT'].includes(currencyCode);
  const mojo = isGoldcoinCurrency 
    ? goldcoinToMojo(correctedValue) 
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isGoldcoinCurrency ? 12 : 3,
          },
          endAdornment: (
