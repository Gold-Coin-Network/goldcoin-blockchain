...
import icon from '../../assets/img/goldcoin_circle.svg';
...
const url = 'https://goldcoin-network.net';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) {currentYear} Goldcoin Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Goldcoin-Network/goldcoin-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
