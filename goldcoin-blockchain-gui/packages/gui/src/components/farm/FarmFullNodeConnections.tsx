...
import { useGetFarmerFullNodeConnectionsQuery, useIsServiceRunningQuery } from '@goldcoin/api-react';
import type { Connection } from '@goldcoin/api';
import { ServiceName } from '@goldcoin/api';
