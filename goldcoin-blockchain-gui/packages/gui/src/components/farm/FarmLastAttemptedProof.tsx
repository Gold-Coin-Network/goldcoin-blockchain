...
import { Link, Loading, Table, Card, FormatBytes } from '@goldcoin/core';
import { useGetFarmingInfoQuery } from '@goldcoin/api-react';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link
            target="_blank"
            href="https://github.com/Goldcoin-Network/goldcoin-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it"
          >
            Learn more
          </Link>
        </Trans>
