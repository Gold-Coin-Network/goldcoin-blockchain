...
import { Link, Table, Card } from '@goldcoin/core';
import { useGetSignagePointsQuery, useGetCombinedPlotsQuery } from '@goldcoin/api-react';
  ...
  return (
    ...
    >
      ...
      <Typography variant="caption">
        <Trans>
          *Want to explore Goldcoin’s blocks further? Check out{' '}
          <Link
            color="primary"
            href="https://www.goldcoinexplorer.com/"
            target="_blank"
          >
            Goldcoin Explorer
          </Link>{' '}
