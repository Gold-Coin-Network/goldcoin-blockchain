...
import { CardStep, Select, StateColor } from '@goldcoin/core';
import { useGetPlottersQuery } from '@goldcoin/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@goldcoin/api';
import type { Plotter, PlotterMap } from '@goldcoin/api';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    displayablePlotters.sort((a, b) => a == PlotterName.GOLDCOINPOS ? -1 : a.localeCompare(b));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Goldcoin Proof of Space plotter. If unsure,
            use the default Goldcoin Proof of Space plotter.
        </Trans>
      </Typography>
