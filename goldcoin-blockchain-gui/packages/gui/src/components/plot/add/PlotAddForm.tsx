...
import { defaultPlotter } from '@goldcoin/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@goldcoin/api-react';
import { ChevronRight as ChevronRightIcon } from '@material-ui/icons';
import { useForm, SubmitHandler } from 'react-hook-form';
import { useShowError, ButtonLoading, Flex, Form, FormBackButton } from '@goldcoin/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    ...
    defaultValues: defaultsForPlotter(PlotterName.GOLDCOINPOS),
  });
