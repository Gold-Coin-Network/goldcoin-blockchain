...
import { Plot as PlotIcon } from '@goldcoin/icons';
import { useDeleteUnconfirmedTransactionsMutation } from '@goldcoin/api-react';
...
export default function PlotNFTCard(props: Props) {
  ...
  const rows = [
    ...
    isSelfPooling && {
      ...
      value: (
        <UnitFormat
          value={mojoToGoldcoinLocaleString(balance)}
          state={State.SUCCESS}
        />
      ),
    },
