...
import { CopyToClipboard, Flex, Link, Loading } from '@goldcoin/core';
import {
  Button,
  Dialog,
  DialogActions,
...
import { useGetPoolLoginLinkQuery } from '@goldcoin/api-react';
import type { PlotNFT, PlotNFTExternal } from '@goldcoin/api';
          ...
          {isLoading ? (
            ...
            <Flex flexDirection="column" gap={2}>
              ...
              <Typography variant="body2" color="textSecondary">
                ...
                <Link
                  target="_blank"
                  href="https://github.com/Goldcoin-Network/pool-reference/blob/main/SPECIFICATION.md#get-login"
                  noWrap
                >
