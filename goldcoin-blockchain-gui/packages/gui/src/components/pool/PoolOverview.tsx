...
import { Flex, UnitFormat, More, Table, mojoToGoldcoinLocaleString, Suspender } from '@goldcoin/core';
...
import { WalletStatus } from '@goldcoin/wallets';
  ...
  },
  {
    field: (nft: PlotNFT) => {
      ...
      if (state === PlotNFTStateEnum.SELF_POOLING) {
        return (
          <UnitFormat
            value={mojoToGoldcoinLocaleString(nft.walletBalance.confirmedWalletBalance ?? 0)}
          />
        );
      }
