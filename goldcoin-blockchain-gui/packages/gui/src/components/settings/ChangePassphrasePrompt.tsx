...
import { AlertDialog, Flex, useOpenDialog, Suspender, useValidateChangePassphraseParams } from '@goldcoin/core';
import { useGetKeyringStatusQuery, useRemoveKeyringPassphraseMutation, useSetKeyringPassphraseMutation } from '@goldcoin/api-react';
      ...
      <DialogContent>
        ...
        {!!canSavePassphrase && (
          <Box display="flex" alignItems="center">
            ...
            />
            <Tooltip title={t`Your passphrase can be stored in your system's secure credential store. Goldcoin will be able to access your keys without prompting for your passphrase.`}>
