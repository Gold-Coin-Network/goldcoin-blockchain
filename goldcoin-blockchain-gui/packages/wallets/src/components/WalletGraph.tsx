...
import { useGetWalletBalanceQuery } from '@goldcoin/api-react';
import { TransactionType } from '@goldcoin/api';
import type { Transaction } from '@goldcoin/api';
import { mojoToGoldcoin, blockHeightToTimestamp } from '@goldcoin/core';
  ...
  const points = [
    {
      ...
      y: Math.max(0, Number(mojoToGoldcoin(start))),
      tooltip: mojoToGoldcoin(balance),
    },
  ];
