...
import { goldcoinToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@goldcoin/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = goldcoinToMojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New Goldcoin Asset Token Wallet</Trans>
        </Back>
        <Card>
