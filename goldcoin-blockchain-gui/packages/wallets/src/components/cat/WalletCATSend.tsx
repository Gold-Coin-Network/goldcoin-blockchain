...
} from '@goldcoin/api-react';
import { SyncingStatus } from '@goldcoin/api';
...
export default function WalletCATSend(props: Props) {
  ...
  async function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      throw new Error(t`Cannot send goldcoin to coloured address. Please enter a goldcoin address.`);
    }
    ...
    const feeValue = goldcoinToMojo(fee);
