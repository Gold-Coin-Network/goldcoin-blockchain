...
import { useGetWalletBalanceQuery, useGetWalletsQuery } from '@goldcoin/api-react';
import { Wallet, WalletType } from '@goldcoin/api';
    ...
    if (!isLoading && tradeSide === 'sell' && walletBalance && walletBalance.walletId == row.assetWalletId) {
      switch (item.walletType) {
        case WalletType.STANDARD_WALLET:
          balanceString = mojoToGoldcoinLocaleString(walletBalance.spendableBalance);
          balance = mojoToGoldcoin(walletBalance.spendableBalance);
          break;
        case WalletType.CAT:
