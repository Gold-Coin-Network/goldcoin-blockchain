...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of goldcoin', () => {
      const result = units.getUnit('goldcoin');
    ...
    it('gets unit of goldcoin using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of goldcoin', () => {
      const result = units.getDisplay('goldcoin');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('goldcoin', 9);

      const result = units.getUnit('goldcoin');

      expect(result).toEqual(9);

      units.setUnit('goldcoin', 1);
    });
  });
  describe('#setDisplay', () => {
