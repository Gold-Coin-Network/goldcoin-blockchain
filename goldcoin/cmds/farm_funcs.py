...
from goldcoin.util.misc import format_bytes
from goldcoin.util.misc import format_minutes
from goldcoin.util.network import is_localhost
...
async def summary(
    ...
    if amounts is not None:
        print(f"Total goldcoin farmed: {amounts['farmed_amount'] / units['goldcoin']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['goldcoin']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['pool_reward_amount']) / units['goldcoin']}")
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'goldcoin start wallet' and 'goldcoin wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'goldcoin wallet show'")
    else:
        print("Note: log into your key using 'goldcoin wallet show' to see rewards for each key")
