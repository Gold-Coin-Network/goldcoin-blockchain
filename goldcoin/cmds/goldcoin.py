...
from goldcoin.cmds.configure import configure_cmd
from goldcoin.cmds.farm import farm_cmd
...
@click.group(
    help=f"\n  Manage goldcoin blockchain infrastructure ({__version__})\n",
    epilog="Try 'goldcoin start node', 'goldcoin netspace -d 192', or 'goldcoin show -s'",
