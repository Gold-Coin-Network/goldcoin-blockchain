...
@click.option("--testnet", is_flag=True, help="Configure this goldcoin install to connect to the testnet")
...
def init_cmd(ctx: click.Context, create_certs: str, fix_ssl_permissions: bool, testnet: bool, v1_db: bool, **kwargs):
    ...
    - Make a copy of your Farming Machine CA directory: ~/.goldcoin/[version]/config/ssl/ca
    - Shut down all goldcoin daemon processes with `goldcoin stop all -d`
    - Run `goldcoin init -c [directory]` on your remote harvester,
      where [directory] is the the copy of your Farming Machine CA directory
    - Get more details on remote harvester on Goldcoin wiki:
      https://github.com/Goldcoin-Network/goldcoin-blockchain/wiki/Farming-on-many-machines
    """
    from pathlib import Path
    from .init_funcs import init
    from goldcoin.cmds.passphrase_funcs import initialize_passphrase
...
if __name__ == "__main__":
    from .init_funcs import goldcoin_init
    from goldcoin.util.default_root import DEFAULT_ROOT_PATH

    goldcoin_init(DEFAULT_ROOT_PATH)
