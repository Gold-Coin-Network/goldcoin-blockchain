...
@keys_cmd.command("migrate", short_help="Attempt to migrate keys to the Goldcoin keyring")
@click.pass_context
...
@click.option("--prefix", "-x", help="Address prefix (ozt for mainnet, tozt for testnet)", default=None, type=str)
@click.option(
    "--non-observer-derivation",
    "-d",
