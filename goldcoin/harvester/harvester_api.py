...
from goldcoin.harvester.harvester import Harvester
from goldcoin.plotting.plot_tools import PlotInfo, parse_plot_info
from goldcoin.protocols import harvester_protocol
from goldcoin.protocols.farmer_protocol import FarmingInfo
from goldcoin.protocols.harvester_protocol import Plot
from goldcoin.protocols.protocol_message_types import ProtocolMessageTypes
from goldcoin.server.outbound_message import make_msg
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSgoldcoinConnection
    ):
        """
