"""
NOTE: This contains duplicate code from `goldcoin.cmds.plots`.
After `goldcoin plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Goldcoin Proof of Space", "version": chiapos_version, "installed": True}
...
def plot_goldcoin(args, root_path):
