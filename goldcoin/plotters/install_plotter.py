import os
from goldcoin.plotters.bladebit import install_bladebit
from goldcoin.plotters.madmax import install_madmax


def install_plotter(plotter, root_path):
    if plotter == "chiapos":
        print("Goldcoinpos already installed. No action taken.")
        return
    elif plotter == "madmax":
        if not os.path.exists(root_path / "madmax-plotter/build/goldcoin_plot"):
