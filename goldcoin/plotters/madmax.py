...
from goldcoin.plotting.create_plots import resolve_plot_keys
from goldcoin.plotters.plotters_util import run_plotter, run_command
...
def get_madmax_executable_path_for_ksize(plotters_root_path: Path, ksize: int = 32) -> Path:
    ...
    madmax_exec: str = "goldcoin_plot"
    if ksize > 32:
        madmax_exec += "_k34"  # Use the goldcoin_plot_k34 executable for k-sizes > 32
...
def plot_madmax(args, goldcoin_root_path: Path, plotters_root_path: Path):
