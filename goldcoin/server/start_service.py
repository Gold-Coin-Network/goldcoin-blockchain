...
from goldcoin.daemon.server import singleton, service_launch_lock_path
from goldcoin.server.ssl_context import goldcoin_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        proctitle_name = f"goldcoin_{service_name}"
        ...
        goldcoin_ca_crt, goldcoin_ca_key = goldcoin_ssl_ca_paths(root_path, self.config)
        inbound_rlp = self.config.get("inbound_rate_limit_percent")
        outbound_rlp = self.config.get("outbound_rate_limit_percent")
        assert inbound_rlp and outbound_rlp
        self._server = goldcoinServer(
            advertised_port,
            node,
            peer_api,
            node_type,
            ...
            (goldcoin_ca_crt, goldcoin_ca_key),
    ...
    async def wait_closed(self) -> None:
        ...
        self._log.info("Waiting for goldcoinServer to be closed")
