...
from goldcoin.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from goldcoin.timelord.timelord_state import LastState
from goldcoin.timelord.types import Chain, IterationType, StateType
