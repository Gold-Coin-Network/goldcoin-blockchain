...
from goldcoin.types.blockchain_format.foliage import Foliage, FoliageTransactionBlock, TransactionsInfo
...
from goldcoin.types.blockchain_format.vdf import VDFProof
