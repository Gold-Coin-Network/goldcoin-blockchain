...
from goldcoin.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "goldcoin" in cc_discrepancies:
                    cc_discrepancies["goldcoin"] = cc_discrepancies["goldcoin"] + diff
                else:
                    cc_discrepancies["goldcoin"] = diff
