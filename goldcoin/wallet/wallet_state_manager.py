...
from goldcoin.consensus.coinbase import pool_parent_id, farmer_parent_id
from goldcoin.consensus.constants import ConsensusConstants
from goldcoin.pools.pool_puzzles import SINGLETON_LAUNCHER_HASH, solution_to_pool_state
from goldcoin.pools.pool_wallet import PoolWallet
from goldcoin.protocols import wallet_protocol
from goldcoin.protocols.wallet_protocol import PuzzleSolutionResponse, RespondPuzzleSolution, CoinState
...
from goldcoin.util.ints import uint32, uint64, uint128, uint8
from goldcoin.util.db_synchronous import db_synchronous_on
from goldcoin.wallet.cat_wallet.cat_utils import match_cat_puzzle, construct_cat_puzzle
from goldcoin.wallet.cat_wallet.cat_wallet import CATWallet
...
from goldcoin.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_wallet_sk_unhardened
from goldcoin.wallet.key_val_store import KeyValStore
from goldcoin.wallet.puzzles.cat_loader import CAT_MOD
from goldcoin.wallet.rl_wallet.rl_wallet import RLWallet
from goldcoin.wallet.settings.user_settings import UserSettings
from goldcoin.wallet.trade_manager import TradeManager
from goldcoin.wallet.transaction_record import TransactionRecord
from goldcoin.wallet.util.compute_hints import compute_coin_hints
from goldcoin.wallet.util.transaction_type import TransactionType
from goldcoin.wallet.util.wallet_types import WalletType
from goldcoin.wallet.wallet import Wallet
from goldcoin.wallet.wallet_action import WalletAction
from goldcoin.wallet.wallet_action_store import WalletActionStore
from goldcoin.wallet.wallet_blockchain import WalletBlockchain
from goldcoin.wallet.wallet_coin_record import WalletCoinRecord
from goldcoin.wallet.wallet_coin_store import WalletCoinStore
from goldcoin.wallet.wallet_info import WalletInfo
from goldcoin.wallet.wallet_interested_store import WalletInterestedStore
from goldcoin.wallet.wallet_pool_store import WalletPoolStore
from goldcoin.wallet.wallet_puzzle_store import WalletPuzzleStore
from goldcoin.wallet.wallet_sync_store import WalletSyncStore
from goldcoin.wallet.wallet_transaction_store import WalletTransactionStore
from goldcoin.wallet.wallet_user_store import WalletUserStore
from goldcoin.server.server import GoldcoinServer
from goldcoin.wallet.did_wallet.did_wallet import DIDWallet
from goldcoin.wallet.wallet_weight_proof_handler import WalletWeightProofHandler
...
class WalletStateManager:
    ...
    async def fetch_parent_and_check_for_cat(
        self, peer: WSGoldcoinConnection, coin_state: CoinState, fork_height: Optional[uint32]
    ...
    async def new_coin_state(
        self, coin_states: List[CoinState], peer: WSGoldcoinConnection, fork_height: Optional[uint32]
    ) -> None:
