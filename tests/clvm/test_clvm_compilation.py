...
wallet_program_files = set(
    [
        ...
        "goldcoin/wallet/puzzles/p2_delegated_puzzle.clvm",
        "goldcoin/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "goldcoin/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "goldcoin/wallet/puzzles/p2_puzzle_hash.clvm",
        "goldcoin/wallet/puzzles/rl_aggregation.clvm",
        "goldcoin/wallet/puzzles/rl.clvm",
        "goldcoin/wallet/puzzles/sha256tree_module.clvm",
        "goldcoin/wallet/puzzles/singleton_top_layer.clvm",
        "goldcoin/wallet/puzzles/did_innerpuz.clvm",
        "goldcoin/wallet/puzzles/decompress_puzzle.clvm",
        "goldcoin/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "goldcoin/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "goldcoin/wallet/puzzles/block_program_zero.clvm",
        "goldcoin/wallet/puzzles/test_generator_deserialize.clvm",
        "goldcoin/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "goldcoin/wallet/puzzles/p2_singleton.clvm",
        "goldcoin/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
...
clvm_include_files = set(
    ["goldcoin/wallet/puzzles/create-lock-puzzlehash.clvm", "goldcoin/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "goldcoin/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to goldcoin/wallet/puzzles, but not added to `wallet_program_files`
        """
