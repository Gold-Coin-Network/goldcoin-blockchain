...
from goldcoin.wallet.trading.offer import OFFER_MOD
...
from goldcoin.wallet.cat_wallet.cat_utils import CAT_MOD, construct_cat_puzzle
from goldcoin.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import puzzle_for_pk
