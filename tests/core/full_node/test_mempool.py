...
from goldcoin.util.condition_tools import conditions_for_solution
...
from goldcoin.full_node.mempool_check_conditions import parse_condition_args, parse_condition
