...
from goldcoin.plotting.plot_tools import stream_plot_info_ph, stream_plot_info_pk
from goldcoin.protocols import farmer_protocol
from goldcoin.rpc.farmer_rpc_api import FarmerRpcApi
from goldcoin.rpc.farmer_rpc_client import FarmerRpcClient
from goldcoin.rpc.harvester_rpc_api import HarvesterRpcApi
from goldcoin.rpc.harvester_rpc_client import HarvesterRpcClient
...
from goldcoin.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "ozt"), encode_puzzle_hash(new_ph_2, "ozt"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "ozt"))
            ...
            assert config["farmer"]["ozt_target_address"] == encode_puzzle_hash(new_ph, "ozt")
            assert config["pool"]["ozt_target_address"] == encode_puzzle_hash(new_ph_3, "ozt")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "ozt")
