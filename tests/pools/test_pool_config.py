...
from goldcoin.pools.pool_config import PoolWalletConfig
from goldcoin.util.config import load_config, save_config, create_default_goldcoin_config
...
def test_pool_config():
    ...
    create_default_goldcoin_config(test_root, ["config.yaml"])
