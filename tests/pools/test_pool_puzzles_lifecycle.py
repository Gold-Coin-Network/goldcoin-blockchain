...
from goldcoin.wallet.puzzles.p2_conditions import puzzle_for_conditions
from goldcoin.wallet.puzzles import singleton_top_layer
from goldcoin.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - goldcoin.pools.pool_puzzles.py
    - goldcoin.wallet.puzzles.pool_member_innerpuz.clvm
    - goldcoin.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
...
class TestPoolPuzzles(TestCase):
    def test_pool_lifecycle(self):
        ...
        GENESIS_CHALLENGE = bytes32.fromhex("763b09c965f4ac84f7fcac1025fc06940c4166f56251e94391f6585159d528f0")
