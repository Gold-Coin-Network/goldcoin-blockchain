...
from goldcoin.types.weight_proof import WeightProof, SubEpochData, SubEpochChallengeSegment, SubSlotData, RecentChainData
...
from goldcoin.types.peer_info import TimestampedPeerInfo
from goldcoin.types.blockchain_format.reward_chain_block import RewardChainBlock
from goldcoin.types.blockchain_format.foliage import Foliage, FoliageTransactionBlock, FoliageBlockData, TransactionsInfo

from goldcoin.protocols import (
    farmer_protocol,
    full_node_protocol,
    harvester_protocol,
    introducer_protocol,
...
pool_target = PoolTarget(
    bytes.fromhex("8d04bcaf76369d273c4c8be9b43e394b8cf2d3d497fc9e2487c0200a298a8144"),  # type: ignore[arg-type]
    uint32(421941852),
)
