...
from goldcoin.consensus.block_rewards import calculate_pool_reward, calculate_base_farmer_reward
from goldcoin.protocols import wallet_protocol, full_node_protocol
...
from goldcoin.protocols.wallet_protocol import RespondToCoinUpdates, CoinStateUpdate, RespondToPhUpdates, CoinState
...
class TestSimpleSyncProtocol:
    ...
    async def test_subscribe_for_ph(self, wallet_node_simulator):
        ...
        from goldcoin.wallet.puzzles.singleton_top_layer import SINGLETON_LAUNCHER_HASH
