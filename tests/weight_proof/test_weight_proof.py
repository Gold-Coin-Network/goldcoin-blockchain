...
from goldcoin.consensus.blockchain import Blockchain
...
from goldcoin.server.start_full_node import SERVICE_NAME
...
from goldcoin.consensus.pot_iterations import calculate_iterations_quality
from goldcoin.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
